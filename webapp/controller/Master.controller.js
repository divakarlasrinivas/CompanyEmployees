sap.ui.define([
	...
	return BaseController.extend("com.basf.techInterview.test1.CompanyEmployees.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "com.basf.techInterview.test1.CompanyEmployees.view.ViewSettingsDialog",
					controller: this
