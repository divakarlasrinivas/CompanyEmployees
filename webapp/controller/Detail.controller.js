sap.ui.define([
	...
	return BaseController.extend("com.basf.techInterview.test1.CompanyEmployees.controller.Detail", {
		...
		onTabChange: function (oEvent) {
			...
			if (oEvent.getSource().getSelectedKey() === "map") {
				this.showMap(oEvent);
			}
		},
		_getLatLongFromAdresss: function (address) {
			//TODO: move the url to SCP as a destination
			var oDeferred = $.Deferred();
			var apiKey = 'AIzaSyA35qFDTfvi8zb3MkumOVLThKo86XTbayg'
			var that = this;
