sap.ui.define([
	"sap/ui/test/Opa5",
	"com/basf/techInterview/test1/CompanyEmployees/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.basf.techInterview.test1.CompanyEmployees.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.basf.techInterview.test1.CompanyEmployees",
					async: true
				},
				hash: oOptions.hash,
